...
const clientGetPoByNoG4 = (req, res) => new Promise((resolve, reject) => {
    ...
    const q = `SELECT POLinesG4.poNoG4, POsG4.clientCompIdG4, statusG4, clientCompNameG4, datePOG4, statusDescriptionG4, POLinesG4.partNoG4, linePriceG4, PartsG4.currentPriceG4, POLinesG4.qtyG4 as POqtyG4, PartsG4.qtyG4 as partQtyG4, partNameG4, lineNoG4, (linePriceG4 / POLinesG4.qtyG4) AS partPOUnitPriceG4 FROM POsG4 
    INNER JOIN StatusG4 ON POsG4.statusG4=StatusG4.statusNoG4 
    INNER JOIN ClientG4 ON POsG4.clientCompIdG4=ClientG4.clientCompIdG4 
    INNER JOIN POLinesG4 ON POsG4.poNoG4=POLinesG4.poNoG4
    INNER JOIN PartsG4 ON POLinesG4.partNoG4 = PartsG4.partNoG4 
...
// Added at A5
// Return a Purchase Order Summary By poNoG4
const agentGetPoSummaryG4 = (req, res) => new Promise((resolve, reject) => {
    const clientCompIdG4 = req.params.clientCompIdG4
    const poNoG4 = req.params.poNoG4
    ...
    const q = `SELECT POsG4.poNoG4, POsG4.clientCompIdG4, statusG4, clientCompNameG4, datePOG4, statusDescriptionG4, clientCityG4, moneyOwedG4, SUM(POLinesG4.linePriceG4) AS TOTAL_COST, SUM(POLinesG4.qtyG4) as TOTAL_QTY FROM POsG4 
    INNER JOIN StatusG4 ON POsG4.statusG4=StatusG4.statusNoG4 
    INNER JOIN ClientG4 ON POsG4.clientCompIdG4=ClientG4.clientCompIdG4 
    INNER JOIN POLinesG4 ON POsG4.poNoG4 = POLinesG4.poNoG4 WHERE POsG4.poNoG4=${poNoG4}
    GROUP BY POsG4.poNoG4, POsG4.clientCompIdG4, statusG4, clientCompNameG4, datePOG4, statusDescriptionG4`;
    const db = conn.getDB();
    db.query(q, (err, data) => {
...
const agentGetSummaryPosG4 = (req, res) => new Promise((resolve, reject) => {
    const q = `SELECT POsG4.poNoG4, POsG4.clientCompIdG4, statusG4, clientCompNameG4, datePOG4, statusDescriptionG4, clientCityG4, moneyOwedG4, 
