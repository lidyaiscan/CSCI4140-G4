...
CREATE TABLE IF NOT EXISTS `g4`.`ClientG4` (
  ...
  UNIQUE INDEX `clientCompIdG4_UNIQUE` (`clientCompIdG4` ASC) VISIBLE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `g4`.`StatusG4` (
  ...
  UNIQUE INDEX `statusNoG4_UNIQUE` (`statusNoG4` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `g4`.`POsG4` (
  ...
  PRIMARY KEY (`poNoG4`),
  INDEX `fk_POsG4_ClientG4_idx` (`clientCompIdG4` ASC) VISIBLE,
  INDEX `fk_POsG4_StatusG41_idx` (`statusG4` ASC) VISIBLE,
  UNIQUE INDEX `poNoG4_UNIQUE` (`poNoG4` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `g4`.`PartsG4` (
  ...
  UNIQUE INDEX `partNoG4_UNIQUE` (`partNoG4` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `g4`.`POLinesG4` (
  ...
  INDEX `fk_POLinesG4_POsG41_idx` (`poNoG4` ASC) VISIBLE,
  INDEX `fk_POLinesG4_PartsG41_idx` (`partNoG4` ASC) VISIBLE,
  UNIQUE INDEX `lineNoG4_UNIQUE` (`lineNoG4` ASC) VISIBLE,
