...
const updatePartByNoG4 = (req, res) => new Promise((resolve, reject) => {
    ...
    const q = `UPDATE PartsG4 SET partNameG4='${body.partNameG4}', partDescriptionG4='${body.partDescriptionG4}', currentPriceG4='${body.currentPriceG4}', qtyG4='${body.qtyG4}' WHERE partNoG4='${params.partNoG4}'`;
    const db = conn.getDB();
    db.query(q,  (err, data) => {
